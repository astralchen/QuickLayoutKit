...
@available(iOS 26.0, *)
final class IMessageChatAttachmentPagingLayout: UICollectionViewLayout {
    /// 可独立验证的页面几何及单次手势吸附规则。
...
#Preview("附件分页 · 20 pt 间隔") {
    IMessageChatAttachmentPreviewController(items: IMessageChatPreviewData.attachmentPreviewItems, initialIndex: 0, playbackCoordinator: .init())
}
#endif
