...
@available(iOS 26.0, *)
nonisolated struct IMessageChatAttachmentPreviewRequest: Sendable {
    /// 打开预览的业务来源。
...
@available(iOS 26.0, *)
nonisolated struct IMessageChatAttachmentPreviewItem: Sendable {
    /// 原生自定义内容及系统兼容内容的渲染类型。
    ...
    static func prepare(_ attachment: IMessageChatAttachment) -> [Self] {
        switch attachment {
...
/// 可独立验证的分页和交互关闭规则。
@available(iOS 26.0, *)
nonisolated enum IMessageChatPreviewPolicy {
