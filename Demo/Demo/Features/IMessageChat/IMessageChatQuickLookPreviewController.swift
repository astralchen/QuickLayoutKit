...
@available(iOS 26.0, *)
final class IMessageChatQuickLookPreviewController: QLPreviewController, QLPreviewControllerDataSource, QLPreviewControllerDelegate {
...
@available(iOS 26.0, *)
#Preview("文件预览 · 系统兼容") {
    IMessageChatQuickLookPreviewController(url: IMessageChatPreviewData.attachmentPreviewItems[0].url)
}
#endif
