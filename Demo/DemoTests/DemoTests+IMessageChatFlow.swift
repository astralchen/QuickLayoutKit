...
extension DemoTests {
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatSendReplyAndReadFlowIsDeterministic() async throws {
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatRelocalizesFixturesWithoutRewritingUserText() throws {
        guard #available(iOS 26.0, *) else { return }
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatAudioUsesOutgoingReplyAndReadLifecycle() async throws {
        guard #available(iOS 26.0, *) else { return }
        let sleeper = ControlledIMessageSleeper()
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatTextReplyDoesNotStartAudioSynthesis() async throws {
        guard #available(iOS 26.0, *) else { return }
        let sleeper = ControlledIMessageSleeper()
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatAudioReplyWaitsForDelayAndSynthesis() async throws {
        guard #available(iOS 26.0, *) else { return }
        let sleeper = ControlledIMessageSleeper()
        let synthesizer = ControlledIMessageReplyAudioSynthesizer()
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatAudioReplyFallsBackToSameAudioType() async throws {
        guard #available(iOS 26.0, *) else { return }
        let sleeper = ControlledIMessageSleeper()
        let synthesizer = ControlledIMessageReplyAudioSynthesizer()
        let fileURL = FileManager.default.temporaryDirectory
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatCancelsPendingAudioReplyWithoutAppendingIt()
        async throws {
        guard #available(iOS 26.0, *) else { return }
        let sleeper = ControlledIMessageSleeper()
        let synthesizer = ControlledIMessageReplyAudioSynthesizer()
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatNewAudioMessageQueuesBehindOlderSynthesis()
        async throws {
        guard #available(iOS 26.0, *) else { return }
        let sleeper = ControlledIMessageSleeper()
        let synthesizer = ControlledIMessageReplyAudioSynthesizer()
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatRejectsInvalidAudioAndPreservesAudioOnLocalization()
        throws {
        guard #available(iOS 26.0, *) else { return }
        let localization = MutableIMessageLocalization(prefix: "first")
        let fileURL = FileManager.default.temporaryDirectory
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageSpeechConfigurationMapsBackendsAndLocales() {
        guard #available(iOS 26.0, *) else { return }
        #expect(
    ...
    @Test(.enabled(if: IMessageChatTestAvailability.isSupported)) func iMessageChatViewModelCancelsReplyWhenReleased() async {
        guard #available(iOS 26.0, *) else { return }
        let sleeper = ControlledIMessageSleeper()
